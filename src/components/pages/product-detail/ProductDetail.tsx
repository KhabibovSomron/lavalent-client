                ...
                <div className="detail_info">
                    ...
                    <div className="info_question">
                        <span className="info_question_title">Возникли вопросы?</span>
                            ...
                            <a className='info_question_link' href='https://t.me/Lavalentbags' target='_blank' rel="noopener">
                    ...
                    <div className="info_share">
                        ...
                        <div className="info_share_media">
                            <a href={`https://www.facebook.com/sharer/sharer.php?u=${`https://lavalent.com/${params.category_id}/${params.title}/${params.brand_id}/product-detail/${product.productDetail.id}/`}`} target='_blank' rel="noopener" className="info_share_facebook info_share_items" >
                            ...
                            <a href={`https://twitter.com/intent/tweet?text=Lavalent.ua&url=${`https://lavalent.com/${params.category_id}/${params.title}/${params.brand_id}/product-detail/${product.productDetail.id}/`}`} target='_blank' rel="noopener" className="info_share_twitter info_share_items">
                                <span className="info_share_svg">
                            ...
                            <a href={`https://ru.pinterest.com/pin/create/button/?url=${`https://lavalent.com/${params.category_id}/${params.title}/${params.brand_id}/product-detail/${product.productDetail.id}/`}&media=${images.length !== 0 ? images[0].image : ''}`} target='_blank' rel="noopener" className="info_share_pinterest info_share_items">
                                <span className="info_share_svg">
