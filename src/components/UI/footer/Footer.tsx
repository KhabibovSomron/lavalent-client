    ...
    return (
        <div className='footer'>
            <div className='footer_container'>
                <div className="media">
                    <a href='https://www.facebook.com/sharer/sharer.php?u=https://itchief.ru/javascript/social-buttons' target='_blank' className='footer_media_links footer_facebook'>
                    ...
                    <a href='https://twitter.com/intent/tweet?text=Lavalent.ua&url=https://itchief.ru/javascript/social-buttons' target='_blank' className='footer_media_links footer_twitter'>
                        <span className='footer_media_icons'>
                    ...
                    <a href='https://ru.pinterest.com/pin/create/button/?url=https://only-to-top.ru/blog/coding/2019-11-01-knopki-podelitsya-dlya-sajta.html' className='footer_media_links footer_pintrest'>
                        <span className='footer_media_icons'>
                    ...
                    <a href='https://vk.com/share.php?url=https://itchief.ru/javascript/social-buttons' className='footer_media_links footer_vk'>
                        <span className='footer_media_icons'>
